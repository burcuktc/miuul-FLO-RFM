...
df_ = pd.read_csv("C:/Users/asus/Desktop/miuul/flo_data_20k.csv")
df = df_.copy()
df.head()
...
#RFM analizi müşteri segmentasyonu için kullanılır. Müşterinin satın alma davranışları üzerinde gruplara ayrılması ve bu gruplar üzerinden stratejiler geliştirilmesini sağlar.
#Recency: Müşterinin en son ne zaman alışveriş yaptığını belirtir.
#Frequency:Müşterinin alışveriş yapma sıklığı
#Monetary:Müşterinin bıraktığı parasal değer
...
rfm["recency"] = (analysis_date - df["last_order_date"]).astype('timedelta64[D]') #gün cinsinden
